...
public class ResourceMoney_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_pgomn1_a(editorContext, node);
  }
  private EditorCell createCollection_pgomn1_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_pgomn1_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createConstant_pgomn1_a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_pgomn1_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_pgomn1_c0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_pgomn1_d0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_pgomn1_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_pgomn1_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new ResourceMoney_Editor.numSingleRoleHandler_pgomn1_d0(node, MetaAdapterFactory.getContainmentLink(0xa61bdb2ea7448deL, 0x85237d716d56eee2L, 0x7e59491b2c620ffcL, 0x7e59491b2c62329fL, "num"), editorContext);
    return provider.createCell();
  }
  private class numSingleRoleHandler_pgomn1_d0 extends SingleRoleCellProvider {
    public numSingleRoleHandler_pgomn1_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
